...
std::string CBoard::read_yaml(const std::string & config_path)
{
  ...
  quaternion_canid_ = utils::read<int>(yaml, "quaternion_canid");
  bullet_speed_canid_ = utils::read<int>(yaml, "bullet_speed_canid");
  send_canid_ = utils::read<int>(yaml, "send_canid");
