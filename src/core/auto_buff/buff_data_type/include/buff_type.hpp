...
enum PowerRune_type { SMALL, BIG };  // 大小符
enum FanBlade_type { _target, _unlight, _light };   // 符的激活状态
enum Track_status { TRACK, TEM_LOSE, LOSE };    // 追踪的状态

class FanBlade                                  // 单个扇页的状态
{
public:
